...
import pages.autoPaymentMobilePhone.AutoPaymentPage;
import pages.topUpMobilePhone.MobilePhoneTopUpPage;
...
public class BaseTest {
    ...
    protected AutoPaymentPage autoPaymentPage = new AutoPaymentPage(driver);
